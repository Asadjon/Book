...
import com.cyberpanterra.book.UI.*;
import com.cyberpanterra.book.databinding.ActivityViewBinding;
...
public class ViewActivity extends AppCompatActivity {
    public static final String IS_FAVOURITE_VIEWER = "com.cyberpanterra.book_2.IS_FAVOURITE_VIEWER";
    public static final String CHAPTER_INDEX = "com.cyberpanterra.book_2.CHAPTER_INDEX";
    public static final String THEME_INDEX = "com.cyberpanterra.book_2.THEME_INDEX";
    ...
    private final Runnable mHidePart2Runnable = () -> {
        binding.pdfViewer.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LOW_PROFILE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favouriteViewModel = new ViewModelProvider(this, (ViewModelProvider.Factory) provideFavouriteViewModelFactory()).get(FavouriteViewModel.class);

        Intent intent = getIntent();

        List<Data> chapters = intent.getBooleanExtra(IS_FAVOURITE_VIEWER, false) ?
        ...
        Data chapter = chapters.get(intent.getIntExtra(CHAPTER_INDEX, 0));
        if (chapter instanceof Chapter && intent.hasExtra(THEME_INDEX))
        ...
        try {
            configurator = binding.pdfViewer.fromFile(FileUtils.fileFromAsset(this, "Book.pdf"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void changeFavourite() {
        ...
        if (isFavourite) favouriteViewModel.addData(data);
        else favouriteViewModel.removeData(data);
    }
